import type { Args } from '../lib/useArgs'
import type { Slot } from '../lib/useArgsWithSlots'
            ...
            {args
              ? Object.keys(args).map((key) => (
                  <Table.Row key={key}>
                    ...
                    <Table.Cell>
                      <span className="rounded-default bg-accent border border-emphasis p-1 px-2 text-xs shadow-default selection:bg-subtle">
                        {args[key].type}
                      </span>
                    </Table.Cell>

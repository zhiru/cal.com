...
import type { VariantProps, VariantProps} from 'tailwind-variants';
          ...
          <SheetPrimitive.Content {...props} asChild>
            ...
            >
              <div className="rounded-t-4xl -mb-1 mt-2 flex h-7 w-full items-center justify-center">
                <div className="bg-accent -mr-1 h-1 w-6 rounded-full transition-all group-active:rotate-12" />
                <div className="bg-accent h-1 w-6 rounded-full transition-all group-active:-rotate-12" />
              </div>
